...
function addRow(){
    ...
    cell0.innerHTML=document.getElementById("food").value;
    ...
    cell2.innerHTML=document.getElementById("recommend").value;
    var cell3=tr.insertCell(3);
    cell3.innerHTML=document.getElementById("price").value;
    var cell4=tr.insertCell(4);
    cell4.innerHTML=document.getElementById("statement").value;
